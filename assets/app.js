...
const DEFAULT_FAVICON_URL = 'favicon.svg?v=20260720.4';
...
function renderFaviconSetting(message = '') {
  ...
  $('settingsFaviconStatus').textContent = message || (favicon ? '사용자 지정 아이콘이 선택되어 있습니다.' : '현재 펜촉과 서명선 모양의 파란색 기본 아이콘을 사용합니다.');
}
